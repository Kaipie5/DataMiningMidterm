...
#########SCATTER PLOT#############
##Correlation between number of silver medals and rank of Country in Olypmics
...
plt.scatter(numRank, numSilver)
plt.title("Country Rank Compared to Number of Silver Medals")
